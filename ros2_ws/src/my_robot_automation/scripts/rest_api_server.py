...
class RESTAPIServer(Node):
    ...
    def sensor_data_to_dict(self, sensor_data):
        ...
        return {
            ...
            'distance_left_front': sensor_data.distance_left_front,
            'distance_left_back': sensor_data.distance_left_back,
            'distance_right_front': sensor_data.distance_right_front,
            'distance_right_back': sensor_data.distance_right_back,
            'distance_back_left': sensor_data.distance_back_left,
            'distance_back_right': sensor_data.distance_back_right,
            'ultrasonic_front_left': sensor_data.ultrasonic_front_left,
            'ultrasonic_front_right': sensor_data.ultrasonic_front_right,
            'line_sensor_left': sensor_data.line_sensor_left,
            'line_sensor_center': sensor_data.line_sensor_center,
            'line_sensor_right': sensor_data.line_sensor_right,
