# LKS 2025: Autonomous Mobile Manipulator Project
...
**Autonomous Mobile Manipulator for LKS 2025 Robotics Competition**
...
This repository contains the complete software stack for an autonomous mobile manipulator designed for the LKS 2025 robotics competition. The system integrates a mobile base with an articulated arm, leveraging the ROS 2 framework for robust navigation and manipulation.
...
│   └── src/                   # Your custom ROS 2 packages
│       ├── my_robot_bringup/  # Main bringup package (example)
│       ├── my_robot_navigation/ # Navigation package (example)
│       └── my_robot_manipulation/ # Manipulation package (example)
└── README.md                  # This file
```
...
- **`n8n_data/`**: Persistent storage for n8n workflows, credentials, and custom nodes
- **`ros2_ws/`**: Standard ROS 2 workspace structure following REP-0144
  - `src/`: Where you place your custom ROS 2 packages
  - Each package should follow ROS 2 package structure with `package.xml`, `CMakeLists.txt`/`setup.py`, and source files
...
git clone <your-repo-url> lks_robot_project
...
ros2_sim_container   lks_robot_project-ros2-sim   Up
```
...
2. **Transfer Project Files**
   ...
   scp -r lks_robot_project/ pi@raspberrypi5:/home/ubuntu/
   ```
